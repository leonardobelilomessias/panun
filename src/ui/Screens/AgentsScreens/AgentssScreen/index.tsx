...
function AgentsContainer(){
    ...
    <div className="border  p-6 min-w-80  rounded-xl flex flex-col flex-1 gap-4 relative">
            <div className="flex gap-40">
                ...
                <Link href={'/corretores/novo-corretor'} className="flex bg-primaryPalet p-2 rounded text-white font-medium text-sm h-8 items-center justify-center"><PlusSquare size={16}/> Novo Corretor</Link>
            </div>
...
function AgentsCard(){
    return(
    <Link href={'/corretores/coretor-teste'} className="bg-primaryPalet bg-opacity-[0.03] w-full p-2 rounded-lg relative"> 
        <div className="flex gap-2  items-center ">
            <div className="bg-primaryPalet bg-opacity-40 w-8 h-8 rounded-full"></div>
