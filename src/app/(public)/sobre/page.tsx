...
export default function Sobre() {
  return (
    <div className="space-y-20">
      {/* Hero Section */}
      <section className="relative h-[600px] flex items-center bg-gradient-to-r from-[#008099] to-[#00a0bf] text-white">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <Card className="border-t-4 border-t-[#008099] hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                <Building2 className="h-12 w-12 text-[#008099] mb-4" />
            ...
            <Card className="border-t-4 border-t-[#008099] hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                <Users className="h-12 w-12 text-[#008099] mb-4" />
            ...
            <Card className="border-t-4 border-t-[#008099] hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                <Clock className="h-12 w-12 text-[#008099] mb-4" />
            ...
            <Card className="border-t-4 border-t-[#008099] hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                <Award className="h-12 w-12 text-[#008099] mb-4" />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader className="bg-[#008099]/10 pb-4">
                <CardTitle className="text-[#008099] flex items-center">
                  <span className="bg-[#008099] text-white rounded-full w-8 h-8 flex items-center justify-center mr-2">
                    1
                  </span>
                  Missão
                </CardTitle>
              ...
              <CardContent className="pt-6">
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <span className="bg-[#008099] text-white rounded-full w-5 h-5 flex items-center justify-center text-xs mr-2 mt-0.5">
                      •
                    </span>
                    <span>
                      <strong className="text-[#008099]">Personalização:</strong> Cada cliente é único, assim como suas
                      necessidades.
                    </span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong className="text-[#008099]">Transparência:</strong> Clareza em todas as etapas do processo.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-[#008099] text-white rounded-full w-5 h-5 flex items-center justify-center text-xs mr-2 mt-0.5">
                    ...
                    <span>
                      <strong className="text-[#008099]">Excelência:</strong> Compromisso com a qualidade em cada
                      detalhe.
                    </span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong className="text-[#008099]">Inovação:</strong> Busca constante por soluções criativas e
                      eficientes.
                    </span>
                  </li>
                </ul>
      ...
      <section className="container mx-auto px-4">
            ...
            <Card key={index} className="overflow-hidden hover:shadow-lg transition-all group">
              <CardContent className="p-0">
                <div className="h-64 bg-slate-200 relative overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#008099] to-transparent h-1/2" />
                </div>
                <div className="p-6">
                  <h3 className="text-xl font-bold text-[#008099]">{member.name}</h3>
                  <p className="text-sm font-medium text-[#008099]/70 mb-2">{member.role}</p>
        ...
        <div className="text-center mt-12">
          <Button variant="outline" className="border-[#008099] text-[#008099] hover:bg-[#008099] hover:text-white">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                <div className="bg-[#008099] p-3 rounded-full text-white">
                  <MapPin className="h-6 w-6" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-[#008099]">Sede em Belo Horizonte</h3>
                  <p className="text-muted-foreground">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#008099]">Filial em Florianópolis</h3>
                  <p className="text-muted-foreground">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#008099]">Telefones</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#008099]">E-mail</h3>
            ...
            <Card className="overflow-hidden border-0 shadow-lg">
              <CardHeader className="bg-[#008099] text-white">
                <CardTitle>Envie sua mensagem</CardTitle>
              </CardHeader>
              <CardContent className="p-6 space-y-6">
                <form className="space-y-6">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-[#008099]">
                      Nome completo
                    </Label>
                    <Input id="name" required className="border-[#008099]/20 focus-visible:ring-[#008099]" />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-[#008099]">
                      E-mail
                    </Label>
                    <Input
                      id="email"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phone" className="text-[#008099]">
                      Telefone
                    </Label>
                    <Input
                      id="phone"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="message" className="text-[#008099]">
                      Mensagem
                    </Label>
                    <Textarea
                      id="message"
                  ...
                  <Button type="submit" className="w-full bg-[#008099] hover:bg-[#006a80] text-white">
                    Enviar mensagem
                  </Button>
                </form>
              </CardContent>
      ...
      {/* CTA Final */}
      <section className="bg-[#008099] text-white py-20">
