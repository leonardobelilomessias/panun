...
export function EmptyContainerGeneric({description="Tente mudar ou limpar os filtros.",iconLucid=SearchX,title="Nenhum resultado encontrado",textLink,linkText}:{
    ...
    return(
        <div className=" my-4">
            <div className=" flex flex-col gap-2 items-center justify-center bg-blue-50 text-primary-palet text-center min-h-52">
                {React.createElement(iconLucid, { size: 38, className: "text-primary-palet" })}
