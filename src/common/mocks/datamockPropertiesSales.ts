...
const propertiesSalesData = Array.from({ length: 10 }, () => generateDataProperty());
...
function generateDataClient() {
    return {
        ...
        properties:propertiesSalesData[0]
    };
...
export{ agentsData, propertiesSalesData, clientsData, ownersData };
