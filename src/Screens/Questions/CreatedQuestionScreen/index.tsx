        ...
        <ContainerScreen>
            <div className="flex flex-col align-middle justify-center items-center">
                ...
                <div className=' flex flex-col items-center mt-4 gap-2 justify-center'>
                    <Link className='bg-primary-palet text-white p-1 text-sm rounded hover:bg-blue-400 min-w-36 text-center ' href={ id?`/pergunta/${id}`:'/perguntas'}>
                        <p>Ver pergunta criada</p>
                    </Link >
                    <Link className='border border-primary-palet p-1 hover:bg-blue-100 hover:text-blue-700 text-primary-palet text-sm rounded min-w-36 text-center ' href={'/perguntas'}>
