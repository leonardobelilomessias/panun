    ...
    return(
        <div className="border  p-6 min-w-80  rounded-xl flex flex-col flex-1 gap-4">
            <div className="flex gap-40">
                ...
                <Link href={'/clientes/novo-cliente'} className="flex bg-primary-palet p-2 rounded text-white font-medium text-sm h-8 items-center justify-center"><PlusSquare size={16}/> Novo Cliente</Link>
            </div>
