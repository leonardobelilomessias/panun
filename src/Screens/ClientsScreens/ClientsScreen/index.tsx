    ...
    return (
      <div className="flex flex-col gap-4 container pt-8 min-h-screen">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-[#008099]">Lista de Clientes</h1>
  ...
  return (
    <div className="flex flex-col gap-6 container pt-8 pb-16 min-h-screen">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-[#008099]">Clientes</h1>
      ...
      {filteredClients?.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12 text-center bg-white rounded-lg shadow-sm border border-[#008099]/10">
          ...
          <h3 className="text-lg font-medium text-[#008099]">Nenhum cliente encontrado</h3>
                    ...
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        ...
                        <Badge
                          ...
                          className={client.type === "Pessoa Jurídica" ? "border-[#008099]/30 text-[#008099]" : ""}
                        >
