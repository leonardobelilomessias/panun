...
import { updateAvatarAgent } from "@/lib/supabase/queries/client/Agents/updateAvatarAgent";

export function DialogFormAvatar({ avatar, idAvatar, reloadEdit }: PropertyGalleryProps) {
    return (
        <DialogCloseButton idAvatar={idAvatar} avatar={avatar} reloadEdit={reloadEdit} />
    );
}
...
export function DialogCloseButton({ avatar, idAvatar, reloadEdit }: PropertyGalleryProps) {
    const [coverFile, setCoverFile] = useState<File | null>(null)
    const [mainImagePreview, setMainImagePreview] = useState<string | null>(avatar || null)
    ...
    async function onSubmit(data: FormValues) {
        try {
            ...
            if (coverFile) {
                ...
                const result = await updateAvatarAgent(idAvatar, formData);
    ...
    return (
        <div>
            <Button variant={"link"} onClick={openModal} className=" text-primary-palet ">
                Editar Foto
            </Button>
