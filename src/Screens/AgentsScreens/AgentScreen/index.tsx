      ...
      <ContainerScreen>
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-[#272525]">Lista de Corretores</h1>
    ...
    <ContainerScreen>
      <div className="flex flex-col gap-6">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-[#272525]">Corretores</h1>
        ...
        {filteredAgents?.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center bg-white rounded-lg shadow-sm border border-[#272525]/10">
            <div className="bg-[#272525]/10 p-4 rounded-full mb-4">
              <UserCheck className="h-12 w-12 text-[#272525]" />
            </div>
            <h3 className="text-lg font-medium text-[#272525]">Nenhum corretor encontrado</h3>
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col md:flex-row justify-between gap-4">
                      <div className="flex items-start gap-4">
                        <Avatar className="h-16 w-16 border border-[#272525]/20">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-2 mt-3">
                            ...
                            {agent.creci && (
                              <div className="flex items-center gap-2 text-sm">
                                <BadgeCheck className="h-4 w-4 text-[#272525]/70" />
