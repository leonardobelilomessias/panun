...
const fetcher = async ([page, limit, searchTerm, sortBy]: [number, number, string, string]) => {
  const result = await listSalesPropertiesPagination(page, limit, searchTerm, sortBy)
  return result
}
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <p className="text-xl opacity-90 mt-2">
              Explore nossa seleção exclusiva de propriedades à venda em localizações privilegiadas
            </p>
          </div>
