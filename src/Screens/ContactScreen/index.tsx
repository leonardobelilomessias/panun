...
export default function ContactScreen() {
    return (
        <div className="flex">
            <div className=" bg-primary-palet w-1/2 h-[100vh] flex-1  justify-center hidden sm:flex">
                <div className=" mt-[30%] " >
            ...
            <div className="  flex flex-col bg-white w-1/2 h-[100vh]  flex-1 p-10 items-center  gap-20 py-28">
                ...
                <div className="flex  w-[50rem items-center gap-1 md:gap-12 text-center  flex-wrap flex-col md:flex-row">
                    <div className="h-44 flex flex-col items-center">
                        <Mail size={52} className="text-primary-palet" />
                        <p className="text-xl font-bold text-primary-palet">Email</p>
                        <div>
                        <p className="text-gray-600 font-medium">contato@panum.com</p>
                        </div>
                    </div>
                    <div className="h-44 flex flex-col items-center" >
                        <Phone size={52} className="text-primary-palet" />
                        <div>
                            <p className="text-xl font-bold text-primary-palet">Telefone</p>
                    ...
                    <div className="h-44 flex flex-col items-center">
                        <Share2 size={52}  className="text-primary-palet" />
                        <div>
                        <p className="text-xl font-bold text-primary-palet">Redes Sociais</p>
